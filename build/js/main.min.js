...
var initGallerySwiper = function initGallerySwiper() {
  return new Swiper('.photo-gallery__swiper', {
    navigation: {
...
var initHeroSwiper = function initHeroSwiper() {
  ...
  var videoButton = document.querySelector('.hero__video-play');
  ...
  heroSlider.on('slideChange', function () {
    ...
    var audioIframe = audioWrapper.querySelector('iframe');
...
var initMenu = function initMenu() {
  ...
  var phoneLink = document.querySelector('.main-nav__phone-link');
  ...
  var clickOutsideMenu = function clickOutsideMenu(event) {
    if (!navMain.contains(event.target) && !navToggle.contains(event.target)) {
      closeMenu();
    }
  };
  var escapePress = function escapePress(event) {
    if (event.key === 'Escape') {
      closeMenu();
    }
  };
